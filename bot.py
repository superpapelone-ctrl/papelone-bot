...
Breve e chiaro. In italiano."""
        ...
        await query.message.reply_text("✅ Ottimo!\n\n/start per il menu.")
...
ESEMPI:
- "devo chiamare mario" → {"action": "save", "tasks": [{"title": "Chiamare Mario", ...}], "response": "Ok, salvato!"}
- "il porco" → {"action": "ask", "response": "Il porco? 😄 Dimmi di più — è qualcosa da comprare, da fare, o una persona?"}
- "casa" → {"action": "ask", "response": "Cosa c'è da fare in casa?"}"""
